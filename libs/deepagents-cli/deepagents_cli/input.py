...
def get_bottom_toolbar(
    ...
    # Add debouncing to prevent excessive redraws
    last_toolbar_state = {}
    
    def toolbar() -> list[tuple[str, str]]:
        nonlocal last_toolbar_state
        ...
        # Check if state changed to avoid unnecessary redraws
        if (current_state == last_toolbar_state and
            hasattr(toolbar, '_last_parts') and
            toolbar._last_parts):
            return toolbar._last_parts
        ...
        # Cache current state and parts
        last_toolbar_state = current_state.copy()
        toolbar._last_parts = parts
